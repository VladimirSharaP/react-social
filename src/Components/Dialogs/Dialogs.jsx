...
const Dialogs = (props) => {
    ...
    let dialogs = props.dialogsData.dialogsData.map(d => <DialogsItem key={d.id} name={d.name} />);
    let messages = props.dialogsData.messagesData.map(m => <Message key={m.id} message={m.message} />);
